...
class ImageGenerationService:
    ...
    def _enhance_prompt(self, prompt: str, width: int = 1280, height: int = 720) -> str:
        ...
        Portrait images (stories) get vertical-specific modifiers.
        Landscape images (blog covers) get wide-format modifiers.
        """
    ...
    async def _generate_with_pollinations(self, prompt: str, width: int, height: int) -> bytes | None:
        """
        FALLBACK: Generate image using Pollinations.ai (100% free, no key needed).
